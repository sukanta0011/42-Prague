...
def test_processor():
    ...
    print(numeric.format_output(numeric.process([1, 2, '3'])))
    print(text.format_output(text.process("Hello World!")))
    print(log.format_output(log.process("INFO: System ready")))
    print()
